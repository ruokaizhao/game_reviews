...
games = ["Call-of-Duty", "Resident-Evil-Village", "Battlefield-2042", "Marvel's-Spider-Man", "Far-Cry-6", "NBA-2K22", "Fortnite", "Minecraft", "Grand-Theft-Auto-V", "Roblox"]

prices = {"Call-of-Duty" => 53, "Resident-Evil-Village" => 60, "Battlefield-2042" => 45, "Marvel's-Spider-Man" => 30, "Far-Cry-6" => 30, "NBA-2K22" => 20, "Fortnite" => 30, "Minecraft" => 20, "Grand-Theft-Auto-V" => 24, "Roblox" => 10}
...
introductions = {
  ...
  "Marvel's-Spider-Man" => "Players swing around New York City as Miles Morales, the Spidey featured in Spider-Man => Into the Spider-Verse (which is getting a sequel this year), in this comic-inspired game. As Morales completes different missions and assignments, he unlocks different gadgets and suits to help him along the way.",
...
companies = {"Call-of-Duty" => "ACTIVISION", "Resident-Evil-Village" => "CAPCOM", "Battlefield-2042" => "ELECTRONIC ARTS", "Marvel's-Spider-Man" => "SONY", "Far-Cry-6" => "UBISOFT", "NBA-2K22" => "2K", "Fortnite" => "EPIC GAMES", "Minecraft" => "MICROSOFT", "Grand-Theft-Auto-V" => "ROCKSTAR GAMES", "Roblox" => "ROBLOX"}
...
imgs = {
  ...
  "Marvel's-Spider-Man" => "https://m.media-amazon.com/images/I/71LZm8RQ8LL._SL1361_.jpg", 
...
reviews = {
  ...
  "Marvel's-Spider-Man" => ["Superhero!", "I'm Spider-man!"], 
...
reviews.each do |key, value|
  value.each.with_index do |review, index|
    Review.create(review: review, game_id: Game.find_by(name: key).id, user_id: User.ids[index])
  end
end
